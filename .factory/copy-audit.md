...
Audited 5 September 2026. Counts treat hyphenated terms as one word. No line
contains a banned marketing word. No sentence exceeds 22 words.
...
| How to play | 3 | Pass |
| Capture numbered nodes. | 3 | Pass |
| Steer through a relay to add two points. | 9 | Pass |
| Break your trail. | 3 | Pass |
| Press dash to stop drawing briefly and cross any trail. | 10 | Pass |
...
| --- | --- |
| A timed play session | round |
| A numbered capture target | relay |
| The line behind a player | trail |
